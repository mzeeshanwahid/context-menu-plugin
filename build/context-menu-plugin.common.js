...
__vue_render__._withStripped = true;
  ...
  function __vue_normalize__(
    ...
    component.__file = "/media/work/Projects/context-menu-plugin/src/menu/Item.vue";
...
__vue_render__$1._withStripped = true;
  ...
  function __vue_normalize__$1(
    ...
    // For security concerns, we use only base name in production mode.
    component.__file = "/media/work/Projects/context-menu-plugin/src/menu/Search.vue";
...
__vue_render__$2._withStripped = true;
  ...
  function __vue_normalize__$2(
    ...
    // For security concerns, we use only base name in production mode.
    component.__file = "/media/work/Projects/context-menu-plugin/src/menu/Menu.vue";
  ...
  editor.on('contextmenu', function (_ref2) {
    ...
    if (node) {
      menu = new NodeMenu(editor, {
        searchBar: false,
        delay: delay
      }, vueComponent, lodash.isFunction(nodeItems) ? nodeItems(node) : nodeItems);
      menu.show(x, y, {
        node: node
      });
    } else {
